...
class Qualification(models.Model):
    ...
    def __str__(self):
        return f"{self.doctor.first_name} {self.doctor.last_name} - {self.study}"
...
class Appointment(models.Model):
    ...
    def __str__(self):
        return f"Appointment {self.id} - {self.customer.first_name} {self.customer.last_name} with Dr. {self.doctor.last_name}"
